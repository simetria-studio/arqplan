...
export default {
    ...
    methods: {      
        ...
        loadData: function() {
            this.showLoading();
            axios.get('/api/finance/toreceive/'+this.range).then((response)=>{
                    ...
                    <table class="table col-12" ref="table">
                        ...
                        <tbody>                      
                            <tr v-bind:key="transaction.id" v-for="transaction in transactions">
                                ...
                                <td class="fsize14"><money-text :value="parseFloat(transaction.type == 'C' ? transaction.amount : -transaction.amount)" :colored="false" :ignoreSignal="true" /></td>
