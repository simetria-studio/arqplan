...
export default {
    ...
    methods: {      
        ...
        loadData: function() {
            this.showLoading();
            axios.get('/api/projects/count').then((response)=>{
                this.value = response.data.projects;
            }).finally(()=>{
                this.hideLoading();
            });
        },
        ...
        <div class="card-body">
            ...
            <div class="d-flex d-lg-flex d-md-block align-items-center">
                <div>
                    ...
                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Projetos</h6>
                </div>
